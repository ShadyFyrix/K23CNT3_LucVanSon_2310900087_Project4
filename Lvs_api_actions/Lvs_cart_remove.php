<?php
/**
 * Lvs_api_actions/Lvs_cart_remove.php — AJAX: Xóa item khỏi giỏ hàng
 * Định danh Lvs_ | Tác giả: Lục Văn Sơn (2310900087)
 * Backend: DELETE /api/cart/remove/{user_id}/{product_id}
 */
...
$Lvs_res    = Lvs_removeCartItem($Lvs_userId, $Lvs_productId);
